/**
 * Định nghĩa riêng một Class ApiError kế thừa class Error sẵn (Điều này cần thiết và là best practice vì class)
 * 
 */
class ApiError extends Error {
  constructor(statusCode, message) {
    // Gọi tới hàm khởi tạo của class Error (class cha) để còn dùng this
    // Lớp cha (Error) có property message rồi nên gọi nó luôn trong super cho gọn
    super(message)
